...
### Added
- Added the CVE-2026-54121 AD CS Certighost detection pack with BROAD network chase and STRICT EventID 4887 certificate-issuance rules, plus bilingual SOC documentation and a safe validation lab.
